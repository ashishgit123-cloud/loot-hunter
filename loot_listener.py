...
async def discover_channels():
    ...
    try:
        ...
        # Show newly discovered channels
    ...
    while True:
        ...
        try:
            ...
            print(
                ...
                f"🌐 Web Sources: "
                f"PriceHistory + PriceTrail + Buyhatke\n"
                f"📤 Sent Deals: "
...
async def main():
    ...
    # --------------------------------------------------------
    # Initial Telegram source discovery
    # --------------------------------------------------------
